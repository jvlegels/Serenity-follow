const BUY_PATTERNS = [
  /\b(buy|buying|bought|accumulate|adding|added|long|ape(?:ing)?|entry|load(?:ing)? up)\b/i,
  /\b(i(?:'|’)m in|i am in|position(?:ed)? in)\b/i
];

const HEDGE_PATTERNS = [
  /\b(not financial advice|nfa|watch(?:ing)?|if .* breaks|might|maybe|could|wait(?:ing)?|no entry|do not buy|don't buy)\b/i,
